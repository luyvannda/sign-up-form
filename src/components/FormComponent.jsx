...
function FormComponent() {
  ...
  return (
    <div id="form-container" className="container col-11 mb-3 d-grid rounded-3">
      <Form className="rounded-3 mx-3" noValidate validated={validated} onSubmit={handleSubmit}>

        <Form.Group as={Col} md="11" controlId="firstName">
        ...
        <Form.Group as={Col} md="11" controlId="lastName">
          <Form.Label></Form.Label>
          <Form.Control
            required
            type="text"
        ...
        <Form.Group as={Col} md="11" controlId="email">
          <Form.Label></Form.Label>
        ...
        <Form.Group as={Col} md="11" controlId="password">
          <Form.Label></Form.Label>
          <Form.Control
            required
            type="password"
